...
--
-- Installs the index_pilot schema, tables, functions, and FDW/dblink helpers.
-- Run this in the leandex control database, normally named index_pilot_control.
--
-- Example:
--   psql -d index_pilot_control -f leandex.sql
--
-- The SQL schema remains index_pilot for compatibility with the original component.
