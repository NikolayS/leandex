...
begin
  ...
  delete from leandex.reindex_history where schemaname = 'test_reindex';
  delete from leandex.index_latest_state where schemaname = 'test_reindex';
...
begin
  ...
  from leandex._remote_get_indexes_info(_target_db, 'test_reindex', 'test_table', 'idx_test_data')
  limit 1;
