...
usage() {
  {
    ...
    echo ""
    echo "leandex Test Suite - Control Database Architecture"
    echo ""
    echo "This test suite requires control database architecture:"
    echo "  - Control DB: \\${DB_NAME}_control (contains leandex schema)"
...
if [[ "${SKIP_INSTALL}" != "true" ]]; then
  ...
  # Install leandex in control database
  echo "Installing leandex in control database..."
